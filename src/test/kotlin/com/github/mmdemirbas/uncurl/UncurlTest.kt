...
class UncurlTest {
    data class TestCase(val input: List<String>, val expected: Uncurl)
    ...
    private fun `test uncurl`() = listOf(listOf("curl", "https://google.com").gives(Uncurl(method = HttpMethod.GET,
                                         ...
                                         listOf("curl",
                                                ...
                                                "-H",
                                                "Cache-Control: no-cache").gives(Uncurl(method = HttpMethod.GET,
    ...
    private fun List<String>.gives(expected: Uncurl) = TestCase(this, expected)
}